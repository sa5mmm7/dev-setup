...
install_gcloud() {
  ...
  # Add zsh completion (gcloud is in PATH automatically via apt install)
  # shellcheck disable=SC2016
  append_zshrc 'source /usr/share/google-cloud-sdk/completion.zsh.inc'
}
...
configure_adc() {
  ...
  info "Your browser will open — log in with your Meow Wolf Google account."
